 ...
 * @description Zod schemas para Stock con soporte para OpenAPI.
 */
...
registry.registerPath({
  ...
  responses: {
    200: {
      description: 'Stock actualizado exitosamente (Upsert)',
    },
    201: {
...
registry.registerPath({
  ...
  security: [{ cookieAuth: [] }],
  request: {
    query: z.object({ limite: z.coerce.number().int().optional().openapi({ description: 'Cantidad mínima para considerar stock bajo' }) })
  },
  responses: {
    200: {
...
registry.registerPath({
  ...
  responses: {
    200: {
      description: 'Registro de stock eliminado',
    },
    404: {
